...
open class SpinWheelControl: UIControl {
    ...
    public func drawWheel() {
        ...
        for wedgeNumber in 0..<numberOfWedges {
            ...
            //Wedge ImageView
            wedge.imageView.configureWedgeImageView(index: wedgeNumber, width: radius * 0.35, position: spinWheelCenter, radiansPerWedge: radiansPerWedge)
            wedge.addSubview(wedge.imageView)
